...
router.post('/', async (req, res) => {
    ...
    const newEquipo = new equipoModel({
        activo, serial, nombre, marca, modelo, descripcion, placa,
        proveedor, fechaInstalacion, fechaRetiro, fechaFinSoporte,
        fechaFinLicencia, ipGestion, macAddress, sistemaOperativo,
...
router.get('/equipos/edit/:id', async (req, res) => {
    ...
    const proveedores = await proveedorModel.find().lean()
    const proveedor = equipo.proveedor
    ...
    res.render('partials/modalEquipoEdit', { equipo, proveedores, activities, proveedor })
})
...
router.put('/equipos/edit/:id', async (req, res) => {
    ...
    const editEquipo = {
        ...
        proveedor, fechaInstalacion, fechaRetiro, fechaFinSoporte,
        fechaFinLicencia, ipGestion, macAddress, sistemaOperativo,
        rack, urack, linea, tipo, infoAdicional, actividades
    } = req.body;



    await equipoModel.findByIdAndUpdate(req.params.id, {
        activo, serial, nombre, marca, modelo, descripcion, placa,
        proveedor, fechaInstalacion, fechaRetiro, fechaFinSoporte,
        fechaFinLicencia, ipGestion, macAddress, sistemaOperativo,
        rack, urack, linea, tipo, infoAdicional
...
router.post('/proveedores', async (req, res) => {
    ...
    const newProveedor = new proveedorModel({
        nombre, representante, orden, telRep, correoRep, adicionalRep, fechaInicio,
